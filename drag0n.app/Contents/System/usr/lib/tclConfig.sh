...
# build directory.
TCL_BUILD_LIB_SPEC='-F/private/var/tmp/tcl/tcl-97.1~55/tcl/Deployment -framework Tcl'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/private/var/tmp/tcl/tcl-97.1~55/tcl/Deployment -ltclstub8.5'
...
TCL_BUILD_STUB_LIB_PATH='/private/var/tmp/tcl/tcl-97.1~55/tcl/Deployment/libtclstub8.5.a'
