...
enum opt_code
{
  ...
  OPT_Wnonportable_cfstrings = 291,          /* -Wnonportable-cfstrings */
  ...
  OPT_Z = 414,                               /* -Z */
  OPT_Zall_load = 415,                       /* -Zall_load */
  OPT_Zallowable_client = 416,               /* -Zallowable_client */
  OPT_Zarch_errors_fatal = 417,              /* -Zarch_errors_fatal */
  OPT_Zbind_at_load = 418,                   /* -Zbind_at_load */
  OPT_Zbundle = 419,                         /* -Zbundle */
  OPT_Zbundle_loader = 420,                  /* -Zbundle_loader */
  OPT_Zdead_strip = 421,                     /* -Zdead_strip */
  OPT_Zdylib_file = 422,                     /* -Zdylib_file */
  OPT_Zdynamic = 423,                        /* -Zdynamic */
  OPT_Zdynamiclib = 424,                     /* -Zdynamiclib */
  OPT_Zexported_symbols_list = 425,          /* -Zexported_symbols_list */
  OPT_Zflat_namespace = 426,                 /* -Zflat_namespace */
  OPT_Zfn_seg_addr_table_filename = 427,     /* -Zfn_seg_addr_table_filename */
  OPT_Zforce_cpusubtype_ALL = 428,           /* -Zforce_cpusubtype_ALL */
  OPT_Zforce_flat_namespace = 429,           /* -Zforce_flat_namespace */
  OPT_Zimage_base = 430,                     /* -Zimage_base */
  OPT_Zinit = 431,                           /* -Zinit */
  OPT_Zinstall_name = 432,                   /* -Zinstall_name */
  OPT_Zmulti_module = 433,                   /* -Zmulti_module */
  OPT_Zmultiply_defined = 434,               /* -Zmultiply_defined */
  OPT_Zmultiplydefinedunused = 435,          /* -Zmultiplydefinedunused */
  OPT_Zno_dead_strip_inits_and_terms = 436,  /* -Zno_dead_strip_inits_and_terms */
  OPT_Zseg_addr_table = 437,                 /* -Zseg_addr_table */
  OPT_Zsegaddr = 438,                        /* -Zsegaddr */
  OPT_Zsegs_read_only_addr = 439,            /* -Zsegs_read_only_addr */
  OPT_Zsegs_read_write_addr = 440,           /* -Zsegs_read_write_addr */
  OPT_Zsingle_module = 441,                  /* -Zsingle_module */
  OPT_Zumbrella = 442,                       /* -Zumbrella */
  OPT_Zunexported_symbols_list = 443,        /* -Zunexported_symbols_list */
  OPT_Zweak_reference_mismatches = 444,      /* -Zweak_reference_mismatches */
  /* OPT_all_load = 445, */                  /* -all_load */
  /* OPT_allowable_client = 446, */          /* -allowable_client */
  OPT_ansi = 447,                            /* -ansi */
  OPT_arch = 448,                            /* -arch */
  /* OPT_arch_errors_fatal = 449, */         /* -arch_errors_fatal */
  OPT_aux_info = 450,                        /* -aux-info */
  /* OPT_aux_info_ = 451, */                 /* -aux-info= */
  OPT_auxbase = 452,                         /* -auxbase */
  OPT_auxbase_strip = 453,                   /* -auxbase-strip */
  /* OPT_bind_at_load = 454, */              /* -bind_at_load */
  /* OPT_bootclasspath = 455, */             /* -bootclasspath */
  /* OPT_bundle = 456, */                    /* -bundle */
  /* OPT_bundle_loader = 457, */             /* -bundle_loader */
  OPT_c = 458,                               /* -c */
  /* OPT_classpath = 459, */                 /* -classpath */
  OPT_client_name = 460,                     /* -client_name */
  OPT_compatibility_version = 461,           /* -compatibility_version */
  OPT_coverage = 462,                        /* -coverage */
  OPT_cpp = 463,                             /* -cpp */
  OPT_cpp_ = 464,                            /* -cpp= */
  OPT_current_version = 465,                 /* -current_version */
  OPT_d = 466,                               /* -d */
  /* OPT_dead_strip = 467, */                /* -dead_strip */
  /* OPT_dependency_file = 468, */           /* -dependency-file */
  ...
  /* OPT_dylib_file = 474, */                /* -dylib_file */
  OPT_dylinker = 475,                        /* -dylinker */
  OPT_dylinker_install_name = 476,           /* -dylinker_install_name */
  /* OPT_dynamic = 477, */                   /* -dynamic */
  /* OPT_dynamiclib = 478, */                /* -dynamiclib */
  OPT_e = 479,                               /* -e */
  /* OPT_encoding = 480, */                  /* -encoding */
  OPT_export_dynamic = 481,                  /* -export-dynamic */
  /* OPT_exported_symbols_list = 482, */     /* -exported_symbols_list */
  OPT_extdirs = 483,                         /* -extdirs */
  /* OPT_fCLASSPATH_ = 484, */               /* -fCLASSPATH= */
  OPT_fPIC = 485,                            /* -fPIC */
  OPT_fPIE = 486,                            /* -fPIE */
  OPT_fRTS_ = 487,                           /* -fRTS= */
  OPT_fabi_version_ = 488,                   /* -fabi-version= */
  OPT_faccess_control = 489,                 /* -faccess-control */
  OPT_fada_spec_parent_ = 490,               /* -fada-spec-parent= */
  OPT_faggressive_function_elimination = 491,/* -faggressive-function-elimination */
  OPT_faggressive_loop_optimizations = 492,  /* -faggressive-loop-optimizations */
  OPT_falign_commons = 493,                  /* -falign-commons */
  OPT_falign_functions = 494,                /* -falign-functions */
  OPT_falign_functions_ = 495,               /* -falign-functions= */
  OPT_falign_jumps = 496,                    /* -falign-jumps */
  OPT_falign_jumps_ = 497,                   /* -falign-jumps= */
  OPT_falign_labels = 498,                   /* -falign-labels */
  OPT_falign_labels_ = 499,                  /* -falign-labels= */
  OPT_falign_loops = 500,                    /* -falign-loops */
  OPT_falign_loops_ = 501,                   /* -falign-loops= */
  OPT_fall_intrinsics = 502,                 /* -fall-intrinsics */
  /* OPT_fall_virtual = 503, */              /* -fall-virtual */
  OPT_fallow_leading_underscore = 504,       /* -fallow-leading-underscore */
  OPT_fallow_parameterless_variadic_functions = 505,/* -fallow-parameterless-variadic-functions */
  /* OPT_falt_external_templates = 506, */   /* -falt-external-templates */
  OPT_fapple_kext = 507,                     /* -fapple-kext */
  /* OPT_fargument_alias = 508, */           /* -fargument-alias */
  /* OPT_fargument_noalias = 509, */         /* -fargument-noalias */
  /* OPT_fargument_noalias_anything = 510, *//* -fargument-noalias-anything */
  /* OPT_fargument_noalias_global = 511, */  /* -fargument-noalias-global */
  OPT_fasm = 512,                            /* -fasm */
  OPT_fassert = 513,                         /* -fassert */
  OPT_fassociative_math = 514,               /* -fassociative-math */
  OPT_fassume_compiled = 515,                /* -fassume-compiled */
  OPT_fassume_compiled_ = 516,               /* -fassume-compiled= */
  OPT_fasynchronous_unwind_tables = 517,     /* -fasynchronous-unwind-tables */
  OPT_fauto_inc_dec = 518,                   /* -fauto-inc-dec */
  OPT_fautomatic = 519,                      /* -fautomatic */
  OPT_faux_classpath = 520,                  /* -faux-classpath */
  OPT_fbackslash = 521,                      /* -fbackslash */
  OPT_fbacktrace = 522,                      /* -fbacktrace */
  OPT_fblas_matmul_limit_ = 523,             /* -fblas-matmul-limit= */
  OPT_fbootclasspath_ = 524,                 /* -fbootclasspath= */
  OPT_fbootstrap_classes = 525,              /* -fbootstrap-classes */
  OPT_fbounds_check = 526,                   /* -fbounds-check */
  OPT_fbranch_count_reg = 527,               /* -fbranch-count-reg */
  OPT_fbranch_probabilities = 528,           /* -fbranch-probabilities */
  OPT_fbranch_target_load_optimize = 529,    /* -fbranch-target-load-optimize */
  OPT_fbranch_target_load_optimize2 = 530,   /* -fbranch-target-load-optimize2 */
  OPT_fbtr_bb_exclusive = 531,               /* -fbtr-bb-exclusive */
  OPT_fbuilding_libgcc = 532,                /* -fbuilding-libgcc */
  OPT_fbuiltin = 533,                        /* -fbuiltin */
  OPT_fbuiltin_ = 534,                       /* -fbuiltin- */
  OPT_fcall_saved_ = 535,                    /* -fcall-saved- */
  OPT_fcall_used_ = 536,                     /* -fcall-used- */
  OPT_fcaller_saves = 537,                   /* -fcaller-saves */
  OPT_fcanonical_system_headers = 538,       /* -fcanonical-system-headers */
  OPT_fcheck_array_temporaries = 539,        /* -fcheck-array-temporaries */
  OPT_fcheck_data_deps = 540,                /* -fcheck-data-deps */
  OPT_fcheck_new = 541,                      /* -fcheck-new */
  OPT_fcheck_references = 542,               /* -fcheck-references */
  OPT_fcheck_ = 543,                         /* -fcheck= */
  OPT_fcilkplus = 544,                       /* -fcilkplus */
  OPT_fclasspath_ = 545,                     /* -fclasspath= */
  ...
  OPT_fcompile_resource_ = 553,              /* -fcompile-resource= */
  ...
  OPT_fconvert_big_endian = 559,             /* -fconvert=big-endian */
  OPT_fconvert_little_endian = 560,          /* -fconvert=little-endian */
  OPT_fconvert_native = 561,                 /* -fconvert=native */
  OPT_fconvert_swap = 562,                   /* -fconvert=swap */
  ...
  OPT_fdiagnostics_show_caret = 591,         /* -fdiagnostics-show-caret */
  OPT_fdiagnostics_show_location_ = 592,     /* -fdiagnostics-show-location= */
  OPT_fdiagnostics_show_option = 593,        /* -fdiagnostics-show-option */
  OPT_fdirectives_only = 594,                /* -fdirectives-only */
  OPT_fdisable_ = 595,                       /* -fdisable- */
  OPT_fdisable_assertions = 596,             /* -fdisable-assertions */
  OPT_fdisable_assertions_ = 597,            /* -fdisable-assertions= */
  ...
  OPT_fdump_noaddr = 610,                    /* -fdump-noaddr */
  OPT_fdump_parse_tree = 611,                /* -fdump-parse-tree */
  OPT_fdump_passes = 612,                    /* -fdump-passes */
  OPT_fdump_unnumbered = 613,                /* -fdump-unnumbered */
  OPT_fdump_unnumbered_links = 614,          /* -fdump-unnumbered-links */
  OPT_fdwarf2_cfi_asm = 615,                 /* -fdwarf2-cfi-asm */
  OPT_fearly_inlining = 616,                 /* -fearly-inlining */
  OPT_felide_constructors = 617,             /* -felide-constructors */
  OPT_feliminate_dwarf2_dups = 618,          /* -feliminate-dwarf2-dups */
  OPT_feliminate_unused_debug_symbols = 619, /* -feliminate-unused-debug-symbols */
  OPT_feliminate_unused_debug_types = 620,   /* -feliminate-unused-debug-types */
  OPT_femit_class_debug_always = 621,        /* -femit-class-debug-always */
  OPT_femit_class_file = 622,                /* -femit-class-file */
  OPT_femit_class_files = 623,               /* -femit-class-files */
  ...
  OPT_fenable_assertions = 628,              /* -fenable-assertions */
  OPT_fenable_assertions_ = 629,             /* -fenable-assertions= */
  OPT_fencoding_ = 630,                      /* -fencoding= */
  OPT_fenforce_eh_specs = 631,               /* -fenforce-eh-specs */
  /* OPT_fenum_int_equiv = 632, */           /* -fenum-int-equiv */
  OPT_fexceptions = 633,                     /* -fexceptions */
  OPT_fexcess_precision_ = 634,              /* -fexcess-precision= */
  OPT_fexec_charset_ = 635,                  /* -fexec-charset= */
  OPT_fexpensive_optimizations = 636,        /* -fexpensive-optimizations */
  OPT_fext_numeric_literals = 637,           /* -fext-numeric-literals */
  OPT_fextdirs_ = 638,                       /* -fextdirs= */
  OPT_fextended_identifiers = 639,           /* -fextended-identifiers */
  OPT_fextern_tls_init = 640,                /* -fextern-tls-init */
  OPT_fexternal_blas = 641,                  /* -fexternal-blas */
  /* OPT_fexternal_templates = 642, */       /* -fexternal-templates */
  OPT_ff2c = 643,                            /* -ff2c */
  OPT_ffast_math = 644,                      /* -ffast-math */
  OPT_ffat_lto_objects = 645,                /* -ffat-lto-objects */
  OPT_ffilelist_file = 646,                  /* -ffilelist-file */
  OPT_ffinite_math_only = 647,               /* -ffinite-math-only */
  OPT_ffixed_ = 648,                         /* -ffixed- */
  OPT_ffixed_form = 649,                     /* -ffixed-form */
  OPT_ffixed_line_length_ = 650,             /* -ffixed-line-length- */
  OPT_ffixed_line_length_none = 651,         /* -ffixed-line-length-none */
  OPT_ffloat_store = 652,                    /* -ffloat-store */
  OPT_ffor_scope = 653,                      /* -ffor-scope */
  /* OPT_fforce_addr = 654, */               /* -fforce-addr */
  OPT_fforce_classes_archive_check = 655,    /* -fforce-classes-archive-check */
  OPT_fforward_propagate = 656,              /* -fforward-propagate */
  OPT_ffp_contract_ = 657,                   /* -ffp-contract= */
  OPT_ffpe_summary_ = 658,                   /* -ffpe-summary= */
  OPT_ffpe_trap_ = 659,                      /* -ffpe-trap= */
  OPT_ffree_form = 660,                      /* -ffree-form */
  OPT_ffree_line_length_ = 661,              /* -ffree-line-length- */
  OPT_ffree_line_length_none = 662,          /* -ffree-line-length-none */
  OPT_ffreestanding = 663,                   /* -ffreestanding */
  OPT_ffriend_injection = 664,               /* -ffriend-injection */
  OPT_ffrontend_optimize = 665,              /* -ffrontend-optimize */
  OPT_ffunction_cse = 666,                   /* -ffunction-cse */
  OPT_ffunction_sections = 667,              /* -ffunction-sections */
  OPT_fgcse = 668,                           /* -fgcse */
  OPT_fgcse_after_reload = 669,              /* -fgcse-after-reload */
  OPT_fgcse_las = 670,                       /* -fgcse-las */
  OPT_fgcse_lm = 671,                        /* -fgcse-lm */
  OPT_fgcse_sm = 672,                        /* -fgcse-sm */
  OPT_fgnu_keywords = 673,                   /* -fgnu-keywords */
  OPT_fgnu_runtime = 674,                    /* -fgnu-runtime */
  OPT_fgnu_tm = 675,                         /* -fgnu-tm */
  ...
  OPT_fhash_synchronization = 689,           /* -fhash-synchronization */
  /* OPT_fhelp = 690, */                     /* -fhelp */
  ...
  OPT_findirect_classes = 704,               /* -findirect-classes */
  OPT_findirect_dispatch = 705,              /* -findirect-dispatch */
  OPT_findirect_inlining = 706,              /* -findirect-inlining */
  OPT_findirect_virtual_calls = 707,         /* -findirect-virtual-calls */
  OPT_finhibit_size_directive = 708,         /* -finhibit-size-directive */
  OPT_finit_character_ = 709,                /* -finit-character= */
  OPT_finit_integer_ = 710,                  /* -finit-integer= */
  OPT_finit_local_zero = 711,                /* -finit-local-zero */
  OPT_finit_logical_ = 712,                  /* -finit-logical= */
  OPT_finit_real_ = 713,                     /* -finit-real= */
  OPT_finline = 714,                         /* -finline */
  OPT_finline_atomics = 715,                 /* -finline-atomics */
  OPT_finline_functions = 716,               /* -finline-functions */
  OPT_finline_functions_called_once = 717,   /* -finline-functions-called-once */
  ...
  /* OPT_fipa_matrix_reorg = 730, */         /* -fipa-matrix-reorg */
  OPT_fipa_profile = 731,                    /* -fipa-profile */
  OPT_fipa_pta = 732,                        /* -fipa-pta */
  OPT_fipa_pure_const = 733,                 /* -fipa-pure-const */
  OPT_fipa_reference = 734,                  /* -fipa-reference */
  OPT_fipa_sra = 735,                        /* -fipa-sra */
  /* OPT_fipa_struct_reorg = 736, */         /* -fipa-struct-reorg */
  OPT_fira_algorithm_ = 737,                 /* -fira-algorithm= */
  OPT_fira_hoist_pressure = 738,             /* -fira-hoist-pressure */
  OPT_fira_loop_pressure = 739,              /* -fira-loop-pressure */
  OPT_fira_region_ = 740,                    /* -fira-region= */
  OPT_fira_share_save_slots = 741,           /* -fira-share-save-slots */
  OPT_fira_share_spill_slots = 742,          /* -fira-share-spill-slots */
  OPT_fira_verbose_ = 743,                   /* -fira-verbose= */
  OPT_fivopts = 744,                         /* -fivopts */
  OPT_fjni = 745,                            /* -fjni */
  OPT_fjump_tables = 746,                    /* -fjump-tables */
  OPT_fkeep_inline_dllexport = 747,          /* -fkeep-inline-dllexport */
  OPT_fkeep_inline_functions = 748,          /* -fkeep-inline-functions */
  OPT_fkeep_static_consts = 749,             /* -fkeep-static-consts */
  /* OPT_flabels_ok = 750, */                /* -flabels-ok */
  /* OPT_flat_namespace = 751, */            /* -flat_namespace */
  OPT_flax_vector_conversions = 752,         /* -flax-vector-conversions */
  OPT_fleading_underscore = 753,             /* -fleading-underscore */
  OPT_floop_block = 754,                     /* -floop-block */
  /* OPT_floop_flatten = 755, */             /* -floop-flatten */
  OPT_floop_interchange = 756,               /* -floop-interchange */
  OPT_floop_nest_optimize = 757,             /* -floop-nest-optimize */
  /* OPT_floop_optimize = 758, */            /* -floop-optimize */
  OPT_floop_parallelize_all = 759,           /* -floop-parallelize-all */
  OPT_floop_strip_mine = 760,                /* -floop-strip-mine */
  OPT_flto = 761,                            /* -flto */
  OPT_flto_compression_level_ = 762,         /* -flto-compression-level= */
  OPT_flto_partition_1to1 = 763,             /* -flto-partition=1to1 */
  OPT_flto_partition_balanced = 764,         /* -flto-partition=balanced */
  OPT_flto_partition_max = 765,              /* -flto-partition=max */
  OPT_flto_partition_none = 766,             /* -flto-partition=none */
  OPT_flto_report = 767,                     /* -flto-report */
  OPT_flto_report_wpa = 768,                 /* -flto-report-wpa */
  OPT_flto_ = 769,                           /* -flto= */
  OPT_fltrans = 770,                         /* -fltrans */
  OPT_fltrans_output_list_ = 771,            /* -fltrans-output-list= */
  OPT_fmain_ = 772,                          /* -fmain= */
  OPT_fmath_errno = 773,                     /* -fmath-errno */
  OPT_fmax_array_constructor_ = 774,         /* -fmax-array-constructor= */
  OPT_fmax_errors_ = 775,                    /* -fmax-errors= */
  OPT_fmax_identifier_length_ = 776,         /* -fmax-identifier-length= */
  OPT_fmax_stack_var_size_ = 777,            /* -fmax-stack-var-size= */
  OPT_fmax_subrecord_length_ = 778,          /* -fmax-subrecord-length= */
  OPT_fmem_report = 779,                     /* -fmem-report */
  OPT_fmem_report_wpa = 780,                 /* -fmem-report-wpa */
  OPT_fmerge_all_constants = 781,            /* -fmerge-all-constants */
  OPT_fmerge_constants = 782,                /* -fmerge-constants */
  OPT_fmerge_debug_strings = 783,            /* -fmerge-debug-strings */
  OPT_fmessage_length_ = 784,                /* -fmessage-length= */
  OPT_fmodule_private = 785,                 /* -fmodule-private */
  OPT_fmodulo_sched = 786,                   /* -fmodulo-sched */
  OPT_fmodulo_sched_allow_regmoves = 787,    /* -fmodulo-sched-allow-regmoves */
  OPT_fmove_loop_invariants = 788,           /* -fmove-loop-invariants */
  OPT_fms_extensions = 789,                  /* -fms-extensions */
  OPT_fmudflap = 790,                        /* -fmudflap */
  OPT_fmudflapir = 791,                      /* -fmudflapir */
  OPT_fmudflapth = 792,                      /* -fmudflapth */
  /* OPT_fname_mangling_version_ = 793, */   /* -fname-mangling-version- */
  /* OPT_fnew_abi = 794, */                  /* -fnew-abi */
  OPT_fnext_runtime = 795,                   /* -fnext-runtime */
  OPT_fnil_receivers = 796,                  /* -fnil-receivers */
  OPT_fnon_call_exceptions = 797,            /* -fnon-call-exceptions */
  OPT_fnonansi_builtins = 798,               /* -fnonansi-builtins */
  /* OPT_fnonnull_objects = 799, */          /* -fnonnull-objects */
  OPT_fnothrow_opt = 800,                    /* -fnothrow-opt */
  OPT_fobjc_abi_version_ = 801,              /* -fobjc-abi-version= */
  OPT_fobjc_call_cxx_cdtors = 802,           /* -fobjc-call-cxx-cdtors */
  OPT_fobjc_direct_dispatch = 803,           /* -fobjc-direct-dispatch */
  OPT_fobjc_exceptions = 804,                /* -fobjc-exceptions */
  OPT_fobjc_gc = 805,                        /* -fobjc-gc */
  OPT_fobjc_nilcheck = 806,                  /* -fobjc-nilcheck */
  OPT_fobjc_sjlj_exceptions = 807,           /* -fobjc-sjlj-exceptions */
  OPT_fobjc_std_objc1 = 808,                 /* -fobjc-std=objc1 */
  OPT_fomit_frame_pointer = 809,             /* -fomit-frame-pointer */
  OPT_fopenmp = 810,                         /* -fopenmp */
  OPT_foperator_names = 811,                 /* -foperator-names */
  OPT_fopt_info = 812,                       /* -fopt-info */
  OPT_fopt_info_ = 813,                      /* -fopt-info- */
  OPT_foptimize_register_move = 814,         /* -foptimize-register-move */
  OPT_foptimize_sibling_calls = 815,         /* -foptimize-sibling-calls */
  OPT_foptimize_static_class_initialization = 816,/* -foptimize-static-class-initialization */
  OPT_foptimize_strlen = 817,                /* -foptimize-strlen */
  /* OPT_foptional_diags = 818, */           /* -foptional-diags */
  /* OPT_force_cpusubtype_ALL = 819, */      /* -force_cpusubtype_ALL */
  /* OPT_force_flat_namespace = 820, */      /* -force_flat_namespace */
  OPT_foutput_class_dir_ = 821,              /* -foutput-class-dir= */
  OPT_fpack_derived = 822,                   /* -fpack-derived */
  OPT_fpack_struct = 823,                    /* -fpack-struct */
  OPT_fpack_struct_ = 824,                   /* -fpack-struct= */
  OPT_fpartial_inlining = 825,               /* -fpartial-inlining */
  OPT_fpcc_struct_return = 826,              /* -fpcc-struct-return */
  OPT_fpch_deps = 827,                       /* -fpch-deps */
  OPT_fpch_preprocess = 828,                 /* -fpch-preprocess */
  OPT_fpeel_loops = 829,                     /* -fpeel-loops */
  OPT_fpeephole = 830,                       /* -fpeephole */
  OPT_fpeephole2 = 831,                      /* -fpeephole2 */
  OPT_fpermissive = 832,                     /* -fpermissive */
  OPT_fpic = 833,                            /* -fpic */
  OPT_fpie = 834,                            /* -fpie */
  OPT_fplan9_extensions = 835,               /* -fplan9-extensions */
  OPT_fplugin_arg_ = 836,                    /* -fplugin-arg- */
  OPT_fplugin_ = 837,                        /* -fplugin= */
  OPT_fpost_ipa_mem_report = 838,            /* -fpost-ipa-mem-report */
  OPT_fpre_ipa_mem_report = 839,             /* -fpre-ipa-mem-report */
  OPT_fpredictive_commoning = 840,           /* -fpredictive-commoning */
  OPT_fprefetch_loop_arrays = 841,           /* -fprefetch-loop-arrays */
  OPT_fpreprocessed = 842,                   /* -fpreprocessed */
  OPT_fpretty_templates = 843,               /* -fpretty-templates */
  OPT_fprofile = 844,                        /* -fprofile */
  OPT_fprofile_arcs = 845,                   /* -fprofile-arcs */
  OPT_fprofile_correction = 846,             /* -fprofile-correction */
  OPT_fprofile_dir_ = 847,                   /* -fprofile-dir= */
  OPT_fprofile_generate = 848,               /* -fprofile-generate */
  OPT_fprofile_generate_ = 849,              /* -fprofile-generate= */
  OPT_fprofile_report = 850,                 /* -fprofile-report */
  OPT_fprofile_use = 851,                    /* -fprofile-use */
  OPT_fprofile_use_ = 852,                   /* -fprofile-use= */
  OPT_fprofile_values = 853,                 /* -fprofile-values */
  OPT_fprotect_parens = 854,                 /* -fprotect-parens */
  OPT_framework = 855,                       /* -framework */
  OPT_frandom_seed = 856,                    /* -frandom-seed */
  OPT_frandom_seed_ = 857,                   /* -frandom-seed= */
  OPT_frange_check = 858,                    /* -frange-check */
  OPT_freal_4_real_10 = 859,                 /* -freal-4-real-10 */
  OPT_freal_4_real_16 = 860,                 /* -freal-4-real-16 */
  OPT_freal_4_real_8 = 861,                  /* -freal-4-real-8 */
  OPT_freal_8_real_10 = 862,                 /* -freal-8-real-10 */
  OPT_freal_8_real_16 = 863,                 /* -freal-8-real-16 */
  OPT_freal_8_real_4 = 864,                  /* -freal-8-real-4 */
  OPT_frealloc_lhs = 865,                    /* -frealloc-lhs */
  OPT_freciprocal_math = 866,                /* -freciprocal-math */
  OPT_frecord_gcc_switches = 867,            /* -frecord-gcc-switches */
  OPT_frecord_marker_4 = 868,                /* -frecord-marker=4 */
  OPT_frecord_marker_8 = 869,                /* -frecord-marker=8 */
  OPT_frecursive = 870,                      /* -frecursive */
  OPT_freduced_reflection = 871,             /* -freduced-reflection */
  OPT_free = 872,                            /* -free */
  OPT_freg_struct_return = 873,              /* -freg-struct-return */
  OPT_fregmove = 874,                        /* -fregmove */
  OPT_frename_registers = 875,               /* -frename-registers */
  OPT_freorder_blocks = 876,                 /* -freorder-blocks */
  OPT_freorder_blocks_and_partition = 877,   /* -freorder-blocks-and-partition */
  OPT_freorder_functions = 878,              /* -freorder-functions */
  OPT_frepack_arrays = 879,                  /* -frepack-arrays */
  OPT_freplace_objc_classes = 880,           /* -freplace-objc-classes */
  OPT_frepo = 881,                           /* -frepo */
  OPT_frequire_return_statement = 882,       /* -frequire-return-statement */
  OPT_frerun_cse_after_loop = 883,           /* -frerun-cse-after-loop */
  /* OPT_frerun_loop_opt = 884, */           /* -frerun-loop-opt */
  OPT_freschedule_modulo_scheduled_loops = 885,/* -freschedule-modulo-scheduled-loops */
  OPT_fresolution_ = 886,                    /* -fresolution= */
  OPT_frounding_math = 887,                  /* -frounding-math */
  OPT_frtti = 888,                           /* -frtti */
  OPT_fsanitize_address = 889,               /* -fsanitize=address */
  OPT_fsanitize_thread = 890,                /* -fsanitize=thread */
  OPT_fsaw_java_file = 891,                  /* -fsaw-java-file */
  OPT_fsched_critical_path_heuristic = 892,  /* -fsched-critical-path-heuristic */
  OPT_fsched_dep_count_heuristic = 893,      /* -fsched-dep-count-heuristic */
  OPT_fsched_group_heuristic = 894,          /* -fsched-group-heuristic */
  OPT_fsched_interblock = 895,               /* -fsched-interblock */
  OPT_fsched_last_insn_heuristic = 896,      /* -fsched-last-insn-heuristic */
  OPT_fsched_pressure = 897,                 /* -fsched-pressure */
  OPT_fsched_rank_heuristic = 898,           /* -fsched-rank-heuristic */
  OPT_fsched_spec = 899,                     /* -fsched-spec */
  OPT_fsched_spec_insn_heuristic = 900,      /* -fsched-spec-insn-heuristic */
  OPT_fsched_spec_load = 901,                /* -fsched-spec-load */
  OPT_fsched_spec_load_dangerous = 902,      /* -fsched-spec-load-dangerous */
  OPT_fsched_stalled_insns = 903,            /* -fsched-stalled-insns */
  OPT_fsched_stalled_insns_dep = 904,        /* -fsched-stalled-insns-dep */
  OPT_fsched_stalled_insns_dep_ = 905,       /* -fsched-stalled-insns-dep= */
  OPT_fsched_stalled_insns_ = 906,           /* -fsched-stalled-insns= */
  OPT_fsched_verbose_ = 907,                 /* -fsched-verbose= */
  OPT_fsched2_use_superblocks = 908,         /* -fsched2-use-superblocks */
  /* OPT_fsched2_use_traces = 909, */        /* -fsched2-use-traces */
  OPT_fschedule_insns = 910,                 /* -fschedule-insns */
  OPT_fschedule_insns2 = 911,                /* -fschedule-insns2 */
  OPT_fsecond_underscore = 912,              /* -fsecond-underscore */
  OPT_fsection_anchors = 913,                /* -fsection-anchors */
  /* OPT_fsee = 914, */                      /* -fsee */
  OPT_fsel_sched_pipelining = 915,           /* -fsel-sched-pipelining */
  OPT_fsel_sched_pipelining_outer_loops = 916,/* -fsel-sched-pipelining-outer-loops */
  OPT_fsel_sched_reschedule_pipelined = 917, /* -fsel-sched-reschedule-pipelined */
  OPT_fselective_scheduling = 918,           /* -fselective-scheduling */
  OPT_fselective_scheduling2 = 919,          /* -fselective-scheduling2 */
  OPT_fshort_double = 920,                   /* -fshort-double */
  OPT_fshort_enums = 921,                    /* -fshort-enums */
  OPT_fshort_wchar = 922,                    /* -fshort-wchar */
  OPT_fshow_column = 923,                    /* -fshow-column */
  OPT_fshrink_wrap = 924,                    /* -fshrink-wrap */
  OPT_fsign_zero = 925,                      /* -fsign-zero */
  OPT_fsignaling_nans = 926,                 /* -fsignaling-nans */
  OPT_fsigned_bitfields = 927,               /* -fsigned-bitfields */
  OPT_fsigned_char = 928,                    /* -fsigned-char */
  OPT_fsigned_zeros = 929,                   /* -fsigned-zeros */
  OPT_fsingle_precision_constant = 930,      /* -fsingle-precision-constant */
  OPT_fsource_filename_ = 931,               /* -fsource-filename= */
  OPT_fsource_ = 932,                        /* -fsource= */
  OPT_fsplit_ivs_in_unroller = 933,          /* -fsplit-ivs-in-unroller */
  OPT_fsplit_stack = 934,                    /* -fsplit-stack */
  OPT_fsplit_wide_types = 935,               /* -fsplit-wide-types */
  /* OPT_fsquangle = 936, */                 /* -fsquangle */
  OPT_fstack_arrays = 937,                   /* -fstack-arrays */
  /* OPT_fstack_check = 938, */              /* -fstack-check */
  OPT_fstack_check_ = 939,                   /* -fstack-check= */
  OPT_fstack_limit = 940,                    /* -fstack-limit */
  OPT_fstack_limit_register_ = 941,          /* -fstack-limit-register= */
  OPT_fstack_limit_symbol_ = 942,            /* -fstack-limit-symbol= */
  OPT_fstack_protector = 943,                /* -fstack-protector */
  OPT_fstack_protector_all = 944,            /* -fstack-protector-all */
  OPT_fstack_protector_strong = 945,         /* -fstack-protector-strong */
  OPT_fstack_reuse_ = 946,                   /* -fstack-reuse= */
  OPT_fstack_usage = 947,                    /* -fstack-usage */
  OPT_fstats = 948,                          /* -fstats */
  OPT_fstore_check = 949,                    /* -fstore-check */
  /* OPT_fstrength_reduce = 950, */          /* -fstrength-reduce */
  OPT_fstrict_aliasing = 951,                /* -fstrict-aliasing */
  OPT_fstrict_enums = 952,                   /* -fstrict-enums */
  OPT_fstrict_overflow = 953,                /* -fstrict-overflow */
  /* OPT_fstrict_prototype = 954, */         /* -fstrict-prototype */
  OPT_fstrict_volatile_bitfields = 955,      /* -fstrict-volatile-bitfields */
  OPT_fsync_libcalls = 956,                  /* -fsync-libcalls */
  OPT_fsyntax_only = 957,                    /* -fsyntax-only */
  OPT_ftabstop_ = 958,                       /* -ftabstop= */
  /* OPT_ftarget_help = 959, */              /* -ftarget-help */
  OPT_ftarget_ = 960,                        /* -ftarget= */
  OPT_ftemplate_backtrace_limit_ = 961,      /* -ftemplate-backtrace-limit= */
  /* OPT_ftemplate_depth_ = 962, */          /* -ftemplate-depth- */
  OPT_ftemplate_depth_ = 963,                /* -ftemplate-depth= */
  OPT_fterminated_vtables = 964,             /* -fterminated-vtables */
  OPT_ftest_coverage = 965,                  /* -ftest-coverage */
  /* OPT_fthis_is_variable = 966, */         /* -fthis-is-variable */
  OPT_fthread_jumps = 967,                   /* -fthread-jumps */
  OPT_fthreadsafe_statics = 968,             /* -fthreadsafe-statics */
  OPT_ftime_report = 969,                    /* -ftime-report */
  OPT_ftls_model_ = 970,                     /* -ftls-model= */
  OPT_ftoplevel_reorder = 971,               /* -ftoplevel-reorder */
  OPT_ftracer = 972,                         /* -ftracer */
  OPT_ftrack_macro_expansion = 973,          /* -ftrack-macro-expansion */
  OPT_ftrack_macro_expansion_ = 974,         /* -ftrack-macro-expansion= */
  OPT_ftrapping_math = 975,                  /* -ftrapping-math */
  OPT_ftrapv = 976,                          /* -ftrapv */
  OPT_ftree_bit_ccp = 977,                   /* -ftree-bit-ccp */
  OPT_ftree_builtin_call_dce = 978,          /* -ftree-builtin-call-dce */
  OPT_ftree_ccp = 979,                       /* -ftree-ccp */
  OPT_ftree_ch = 980,                        /* -ftree-ch */
  OPT_ftree_coalesce_inlined_vars = 981,     /* -ftree-coalesce-inlined-vars */
  OPT_ftree_coalesce_vars = 982,             /* -ftree-coalesce-vars */
  OPT_ftree_copy_prop = 983,                 /* -ftree-copy-prop */
  OPT_ftree_copyrename = 984,                /* -ftree-copyrename */
  OPT_ftree_cselim = 985,                    /* -ftree-cselim */
  OPT_ftree_dce = 986,                       /* -ftree-dce */
  OPT_ftree_dominator_opts = 987,            /* -ftree-dominator-opts */
  OPT_ftree_dse = 988,                       /* -ftree-dse */
  OPT_ftree_forwprop = 989,                  /* -ftree-forwprop */
  OPT_ftree_fre = 990,                       /* -ftree-fre */
  OPT_ftree_loop_distribute_patterns = 991,  /* -ftree-loop-distribute-patterns */
  OPT_ftree_loop_distribution = 992,         /* -ftree-loop-distribution */
  OPT_ftree_loop_if_convert = 993,           /* -ftree-loop-if-convert */
  OPT_ftree_loop_if_convert_stores = 994,    /* -ftree-loop-if-convert-stores */
  OPT_ftree_loop_im = 995,                   /* -ftree-loop-im */
  OPT_ftree_loop_ivcanon = 996,              /* -ftree-loop-ivcanon */
  /* OPT_ftree_loop_linear = 997, */         /* -ftree-loop-linear */
  OPT_ftree_loop_optimize = 998,             /* -ftree-loop-optimize */
  OPT_ftree_lrs = 999,                       /* -ftree-lrs */
  OPT_ftree_parallelize_loops_ = 1000,       /* -ftree-parallelize-loops= */
  OPT_ftree_partial_pre = 1001,              /* -ftree-partial-pre */
  OPT_ftree_phiprop = 1002,                  /* -ftree-phiprop */
  OPT_ftree_pre = 1003,                      /* -ftree-pre */
  OPT_ftree_pta = 1004,                      /* -ftree-pta */
  OPT_ftree_reassoc = 1005,                  /* -ftree-reassoc */
  /* OPT_ftree_salias = 1006, */             /* -ftree-salias */
  OPT_ftree_scev_cprop = 1007,               /* -ftree-scev-cprop */
  OPT_ftree_sink = 1008,                     /* -ftree-sink */
  OPT_ftree_slp_vectorize = 1009,            /* -ftree-slp-vectorize */
  OPT_ftree_slsr = 1010,                     /* -ftree-slsr */
  OPT_ftree_sra = 1011,                      /* -ftree-sra */
  /* OPT_ftree_store_ccp = 1012, */          /* -ftree-store-ccp */
  /* OPT_ftree_store_copy_prop = 1013, */    /* -ftree-store-copy-prop */
  OPT_ftree_switch_conversion = 1014,        /* -ftree-switch-conversion */
  OPT_ftree_tail_merge = 1015,               /* -ftree-tail-merge */
  OPT_ftree_ter = 1016,                      /* -ftree-ter */
  OPT_ftree_vect_loop_version = 1017,        /* -ftree-vect-loop-version */
  OPT_ftree_vectorize = 1018,                /* -ftree-vectorize */
  OPT_ftree_vectorizer_verbose_ = 1019,      /* -ftree-vectorizer-verbose= */
  OPT_ftree_vrp = 1020,                      /* -ftree-vrp */
  OPT_funderscoring = 1021,                  /* -funderscoring */
  OPT_funit_at_a_time = 1022,                /* -funit-at-a-time */
  OPT_funroll_all_loops = 1023,              /* -funroll-all-loops */
  OPT_funroll_loops = 1024,                  /* -funroll-loops */
  OPT_funsafe_loop_optimizations = 1025,     /* -funsafe-loop-optimizations */
  OPT_funsafe_math_optimizations = 1026,     /* -funsafe-math-optimizations */
  OPT_funsigned_bitfields = 1027,            /* -funsigned-bitfields */
  OPT_funsigned_char = 1028,                 /* -funsigned-char */
  OPT_funswitch_loops = 1029,                /* -funswitch-loops */
  OPT_funwind_tables = 1030,                 /* -funwind-tables */
  OPT_fuse_atomic_builtins = 1031,           /* -fuse-atomic-builtins */
  OPT_fuse_boehm_gc = 1032,                  /* -fuse-boehm-gc */
  OPT_fuse_cxa_atexit = 1033,                /* -fuse-cxa-atexit */
  OPT_fuse_cxa_get_exception_ptr = 1034,     /* -fuse-cxa-get-exception-ptr */
  OPT_fuse_divide_subroutine = 1035,         /* -fuse-divide-subroutine */
  OPT_fuse_ld_bfd = 1036,                    /* -fuse-ld=bfd */
  OPT_fuse_ld_gold = 1037,                   /* -fuse-ld=gold */
  OPT_fuse_linker_plugin = 1038,             /* -fuse-linker-plugin */
  OPT_fvar_tracking = 1039,                  /* -fvar-tracking */
  OPT_fvar_tracking_assignments = 1040,      /* -fvar-tracking-assignments */
  OPT_fvar_tracking_assignments_toggle = 1041,/* -fvar-tracking-assignments-toggle */
  OPT_fvar_tracking_uninit = 1042,           /* -fvar-tracking-uninit */
  OPT_fvariable_expansion_in_unroller = 1043,/* -fvariable-expansion-in-unroller */
  OPT_fvect_cost_model = 1044,               /* -fvect-cost-model */
  ...
  OPT_fwpa = 1062,                           /* -fwpa */
  OPT_fwrapv = 1063,                         /* -fwrapv */
  /* OPT_fxref = 1064, */                    /* -fxref */
  /* OPT_fzee = 1065, */                     /* -fzee */
  OPT_fzero_initialized_in_bss = 1066,       /* -fzero-initialized-in-bss */
  OPT_fzero_link = 1067,                     /* -fzero-link */
  OPT_g = 1068,                              /* -g */
  OPT_gant = 1069,                           /* -gant */
  OPT_gcoff = 1070,                          /* -gcoff */
  OPT_gdwarf = 1071,                         /* -gdwarf */
  OPT_gdwarf_ = 1072,                        /* -gdwarf- */
  OPT_gen_decls = 1073,                      /* -gen-decls */
  OPT_gfull = 1074,                          /* -gfull */
  OPT_ggdb = 1075,                           /* -ggdb */
  OPT_gnat = 1076,                           /* -gnat */
  OPT_gnatO = 1077,                          /* -gnatO */
  OPT_gno_pubnames = 1078,                   /* -gno-pubnames */
  OPT_gno_record_gcc_switches = 1079,        /* -gno-record-gcc-switches */
  OPT_gno_split_dwarf = 1080,                /* -gno-split-dwarf */
  OPT_gno_strict_dwarf = 1081,               /* -gno-strict-dwarf */
  OPT_gpubnames = 1082,                      /* -gpubnames */
  OPT_grecord_gcc_switches = 1083,           /* -grecord-gcc-switches */
  OPT_gsplit_dwarf = 1084,                   /* -gsplit-dwarf */
  OPT_gstabs = 1085,                         /* -gstabs */
  OPT_gstabs_ = 1086,                        /* -gstabs+ */
  OPT_gstrict_dwarf = 1087,                  /* -gstrict-dwarf */
  OPT_gtoggle = 1088,                        /* -gtoggle */
  OPT_gused = 1089,                          /* -gused */
  OPT_gvms = 1090,                           /* -gvms */
  OPT_gxcoff = 1091,                         /* -gxcoff */
  OPT_gxcoff_ = 1092,                        /* -gxcoff+ */
  OPT_h = 1093,                              /* -h */
  OPT_headerpad_max_install_names = 1094,    /* -headerpad_max_install_names */
  OPT_idirafter = 1095,                      /* -idirafter */
  OPT_iframework = 1096,                     /* -iframework */
  OPT_imacros = 1097,                        /* -imacros */
  /* OPT_image_base = 1098, */               /* -image_base */
  OPT_imultiarch = 1099,                     /* -imultiarch */
  OPT_imultilib = 1100,                      /* -imultilib */
  OPT_include = 1101,                        /* -include */
  /* OPT_init = 1102, */                     /* -init */
  /* OPT_install_name = 1103, */             /* -install_name */
  OPT_iplugindir_ = 1104,                    /* -iplugindir= */
  OPT_iprefix = 1105,                        /* -iprefix */
  OPT_iquote = 1106,                         /* -iquote */
  OPT_isysroot = 1107,                       /* -isysroot */
  OPT_isystem = 1108,                        /* -isystem */
  OPT_iwithprefix = 1109,                    /* -iwithprefix */
  OPT_iwithprefixbefore = 1110,              /* -iwithprefixbefore */
  OPT_k8 = 1111,                             /* -k8 */
  OPT_keep_private_externs = 1112,           /* -keep_private_externs */
  OPT_l = 1113,                              /* -l */
  OPT_lang_asm = 1114,                       /* -lang-asm */
  OPT_m128bit_long_double = 1115,            /* -m128bit-long-double */
  OPT_m32 = 1116,                            /* -m32 */
  OPT_m3dnow = 1117,                         /* -m3dnow */
  OPT_m3dnowa = 1118,                        /* -m3dnowa */
  OPT_m64 = 1119,                            /* -m64 */
  OPT_m80387 = 1120,                         /* -m80387 */
  OPT_m8bit_idiv = 1121,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1122,             /* -m96bit-long-double */
  OPT_mabi_ = 1123,                          /* -mabi= */
  OPT_mabm = 1124,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1125,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1126,                 /* -maddress-mode= */
  OPT_madx = 1127,                           /* -madx */
  OPT_maes = 1128,                           /* -maes */
  OPT_malign_double = 1129,                  /* -malign-double */
  OPT_malign_functions_ = 1130,              /* -malign-functions= */
  OPT_malign_jumps_ = 1131,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1132,                  /* -malign-loops= */
  OPT_malign_stringops = 1133,               /* -malign-stringops */
  OPT_march_ = 1134,                         /* -march= */
  OPT_masm_ = 1135,                          /* -masm= */
  OPT_matt_stubs = 1136,                     /* -matt-stubs */
  OPT_mavx = 1137,                           /* -mavx */
  OPT_mavx2 = 1138,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1139,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1140,  /* -mavx256-split-unaligned-store */
  OPT_mbmi = 1141,                           /* -mbmi */
  OPT_mbmi2 = 1142,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1143,                  /* -mbranch-cost= */
  OPT_mcld = 1144,                           /* -mcld */
  OPT_mcmodel_ = 1145,                       /* -mcmodel= */
  OPT_mconstant_cfstrings = 1146,            /* -mconstant-cfstrings */
  /* OPT_mcpu_ = 1147, */                    /* -mcpu= */
  OPT_mcrc32 = 1148,                         /* -mcrc32 */
  OPT_mcx16 = 1149,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1150,            /* -mdispatch-scheduler */
  OPT_mdynamic_no_pic = 1151,                /* -mdynamic-no-pic */
  OPT_mf16c = 1152,                          /* -mf16c */
  OPT_mfancy_math_387 = 1153,                /* -mfancy-math-387 */
  OPT_mfentry = 1154,                        /* -mfentry */
  OPT_mfix_and_continue = 1155,              /* -mfix-and-continue */
  OPT_mfma = 1156,                           /* -mfma */
  OPT_mfma4 = 1157,                          /* -mfma4 */
  OPT_mforce_drap = 1158,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1159,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1160,                       /* -mfpmath= */
  OPT_mfsgsbase = 1161,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1162, */              /* -mfused-madd */
  OPT_mfxsr = 1163,                          /* -mfxsr */
  OPT_mhard_float = 1164,                    /* -mhard-float */
  OPT_mhle = 1165,                           /* -mhle */
  OPT_mieee_fp = 1166,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1167,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1168,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1169,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1170, */            /* -mintel-syntax */
  OPT_mkernel = 1171,                        /* -mkernel */
  OPT_mlarge_data_threshold_ = 1172,         /* -mlarge-data-threshold= */
  OPT_mlong_double_64 = 1173,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1174,                /* -mlong-double-80 */
  OPT_mlwp = 1175,                           /* -mlwp */
  OPT_mlzcnt = 1176,                         /* -mlzcnt */
  OPT_mmacosx_version_min_ = 1177,           /* -mmacosx-version-min= */
  OPT_mmemcpy_strategy_ = 1178,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1179,              /* -mmemset-strategy= */
  OPT_mmmx = 1180,                           /* -mmmx */
  OPT_mmovbe = 1181,                         /* -mmovbe */
  OPT_mms_bitfields = 1182,                  /* -mms-bitfields */
  OPT_mno_align_stringops = 1183,            /* -mno-align-stringops */
  OPT_mno_fancy_math_387 = 1184,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1185,                  /* -mno-push-args */
  OPT_mno_red_zone = 1186,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1187,                       /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 1188,       /* -momit-leaf-frame-pointer */
  OPT_mone_byte_bool = 1189,                 /* -mone-byte-bool */
  OPT_mpc32 = 1190,                          /* -mpc32 */
  OPT_mpc64 = 1191,                          /* -mpc64 */
  OPT_mpc80 = 1192,                          /* -mpc80 */
  OPT_mpclmul = 1193,                        /* -mpclmul */
  OPT_mpopcnt = 1194,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1195,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1196,     /* -mpreferred-stack-boundary= */
  OPT_mprfchw = 1197,                        /* -mprfchw */
  OPT_mpush_args = 1198,                     /* -mpush-args */
  OPT_mrdrnd = 1199,                         /* -mrdrnd */
  OPT_mrdseed = 1200,                        /* -mrdseed */
  OPT_mrecip = 1201,                         /* -mrecip */
  OPT_mrecip_ = 1202,                        /* -mrecip= */
  OPT_mred_zone = 1203,                      /* -mred-zone */
  OPT_mregparm_ = 1204,                      /* -mregparm= */
  OPT_mrtd = 1205,                           /* -mrtd */
  OPT_mrtm = 1206,                           /* -mrtm */
  OPT_msahf = 1207,                          /* -msahf */
  OPT_msoft_float = 1208,                    /* -msoft-float */
  OPT_msse = 1209,                           /* -msse */
  OPT_msse2 = 1210,                          /* -msse2 */
  OPT_msse2avx = 1211,                       /* -msse2avx */
  OPT_msse3 = 1212,                          /* -msse3 */
  OPT_msse4 = 1213,                          /* -msse4 */
  OPT_msse4_1 = 1214,                        /* -msse4.1 */
  OPT_msse4_2 = 1215,                        /* -msse4.2 */
  OPT_msse4a = 1216,                         /* -msse4a */
  /* OPT_msse5 = 1217, */                    /* -msse5 */
  OPT_msseregparm = 1218,                    /* -msseregparm */
  OPT_mssse3 = 1219,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1220,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_ = 1221,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1222,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1223,            /* -mstringop-strategy= */
  OPT_mtbm = 1224,                           /* -mtbm */
  OPT_mtls_dialect_ = 1225,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1226,           /* -mtls-direct-seg-refs */
  OPT_mtune_ctrl_ = 1227,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1228,                         /* -mtune= */
  /* OPT_multi_module = 1229, */             /* -multi_module */
  /* OPT_multiply_defined = 1230, */         /* -multiply_defined */
  /* OPT_multiply_defined_unused = 1231, */  /* -multiply_defined_unused */
  OPT_mveclibabi_ = 1232,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1233,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1234,                    /* -mvzeroupper */
  OPT_mx32 = 1235,                           /* -mx32 */
  OPT_mxop = 1236,                           /* -mxop */
  OPT_mxsave = 1237,                         /* -mxsave */
  OPT_mxsaveopt = 1238,                      /* -mxsaveopt */
  OPT_n = 1239,                              /* -n */
  OPT_no_canonical_prefixes = 1240,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1241,              /* -no-integrated-cpp */
  /* OPT_no_dead_strip_inits_and_terms = 1242, *//* -no_dead_strip_inits_and_terms */
  OPT_nocpp = 1243,                          /* -nocpp */
  OPT_nodefaultlibs = 1244,                  /* -nodefaultlibs */
  OPT_nofixprebinding = 1245,                /* -nofixprebinding */
  OPT_nomultidefs = 1246,                    /* -nomultidefs */
  OPT_noprebind = 1247,                      /* -noprebind */
  OPT_noseglinkedit = 1248,                  /* -noseglinkedit */
  OPT_nostartfiles = 1249,                   /* -nostartfiles */
  OPT_nostdinc = 1250,                       /* -nostdinc */
  OPT_nostdinc__ = 1251,                     /* -nostdinc++ */
  OPT_nostdlib = 1252,                       /* -nostdlib */
  OPT_o = 1253,                              /* -o */
  OPT_object = 1254,                         /* -object */
  OPT_p = 1255,                              /* -p */
  OPT_pagezero_size = 1256,                  /* -pagezero_size */
  ...
  OPT_pie = 1261,                            /* -pie */
  OPT_pipe = 1262,                           /* -pipe */
  OPT_prebind = 1263,                        /* -prebind */
  OPT_prebind_all_twolevel_modules = 1264,   /* -prebind_all_twolevel_modules */
  OPT_preload = 1265,                        /* -preload */
  OPT_print_file_name_ = 1266,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1267,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1268,          /* -print-multi-directory */
  OPT_print_multi_lib = 1269,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1270,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1271,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1272,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1273,               /* -print-prog-name= */
  OPT_print_search_dirs = 1274,              /* -print-search-dirs */
  OPT_print_sysroot = 1275,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1276,   /* -print-sysroot-headers-suffix */
  OPT_private_bundle = 1277,                 /* -private_bundle */
  OPT_pthread = 1278,                        /* -pthread */
  OPT_quiet = 1279,                          /* -quiet */
  OPT_r = 1280,                              /* -r */
  OPT_read_only_relocs = 1281,               /* -read_only_relocs */
  OPT_remap = 1282,                          /* -remap */
  OPT_s = 1283,                              /* -s */
  OPT_s_bc_abi = 1284,                       /* -s-bc-abi */
  OPT_save_temps = 1285,                     /* -save-temps */
  OPT_save_temps_ = 1286,                    /* -save-temps= */
  OPT_sectalign = 1287,                      /* -sectalign */
  OPT_sectcreate = 1288,                     /* -sectcreate */
  OPT_sectobjectsymbols = 1289,              /* -sectobjectsymbols */
  OPT_sectorder = 1290,                      /* -sectorder */
  OPT_seg1addr = 1291,                       /* -seg1addr */
  /* OPT_seg_addr_table = 1292, */           /* -seg_addr_table */
  /* OPT_seg_addr_table_filename = 1293, */  /* -seg_addr_table_filename */
  /* OPT_segaddr = 1294, */                  /* -segaddr */
  OPT_segcreate = 1295,                      /* -segcreate */
  OPT_seglinkedit = 1296,                    /* -seglinkedit */
  OPT_segprot = 1297,                        /* -segprot */
  /* OPT_segs_read_only_addr = 1298, */      /* -segs_read_only_addr */
  /* OPT_segs_read_write_addr = 1299, */     /* -segs_read_write_addr */
  OPT_shared = 1300,                         /* -shared */
  OPT_shared_libgcc = 1301,                  /* -shared-libgcc */
  /* OPT_single_module = 1302, */            /* -single_module */
  /* OPT_specs = 1303, */                    /* -specs */
  OPT_specs_ = 1304,                         /* -specs= */
  OPT_static = 1305,                         /* -static */
  OPT_static_libasan = 1306,                 /* -static-libasan */
  OPT_static_libgcc = 1307,                  /* -static-libgcc */
  OPT_static_libgcj = 1308,                  /* -static-libgcj */
  OPT_static_libgfortran = 1309,             /* -static-libgfortran */
  OPT_static_libgo = 1310,                   /* -static-libgo */
  OPT_static_libstdc__ = 1311,               /* -static-libstdc++ */
  OPT_static_libtsan = 1312,                 /* -static-libtsan */
  /* OPT_std_c__03 = 1313, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1314, */                /* -std=c++0x */
  OPT_std_c__11 = 1315,                      /* -std=c++11 */
  OPT_std_c__1y = 1316,                      /* -std=c++1y */
  OPT_std_c__98 = 1317,                      /* -std=c++98 */
  OPT_std_c11 = 1318,                        /* -std=c11 */
  /* OPT_std_c1x = 1319, */                  /* -std=c1x */
  /* OPT_std_c89 = 1320, */                  /* -std=c89 */
  OPT_std_c90 = 1321,                        /* -std=c90 */
  OPT_std_c99 = 1322,                        /* -std=c99 */
  /* OPT_std_c9x = 1323, */                  /* -std=c9x */
  OPT_std_f2003 = 1324,                      /* -std=f2003 */
  OPT_std_f2008 = 1325,                      /* -std=f2008 */
  OPT_std_f2008ts = 1326,                    /* -std=f2008ts */
  OPT_std_f95 = 1327,                        /* -std=f95 */
  OPT_std_gnu = 1328,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1329, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1330, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1331,                    /* -std=gnu++11 */
  OPT_std_gnu__1y = 1332,                    /* -std=gnu++1y */
  ...
  OPT_sub_library = 1346,                    /* -sub_library */
  OPT_sub_umbrella = 1347,                   /* -sub_umbrella */
  ...
  OPT_twolevel_namespace = 1355,             /* -twolevel_namespace */
  OPT_twolevel_namespace_hints = 1356,       /* -twolevel_namespace_hints */
  OPT_u = 1357,                              /* -u */
  /* OPT_umbrella = 1358, */                 /* -umbrella */
  OPT_undef = 1359,                          /* -undef */
  OPT_undefined = 1360,                      /* -undefined */
  /* OPT_unexported_symbols_list = 1361, */  /* -unexported_symbols_list */
  OPT_v = 1362,                              /* -v */
  OPT_version = 1363,                        /* -version */
  OPT_w = 1364,                              /* -w */
  /* OPT_weak_reference_mismatches = 1365, *//* -weak_reference_mismatches */
  OPT_whatsloaded = 1366,                    /* -whatsloaded */
  OPT_whyload = 1367,                        /* -whyload */
  OPT_wrapper = 1368,                        /* -wrapper */
  OPT_x = 1369,                              /* -x */
  OPT_y = 1370,                              /* -y */
  OPT_z = 1371,                              /* -z */
  N_OPTS,
